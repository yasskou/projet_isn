...
def déplacementPnjA():
    ...
    if spnjA==3:
        ...
        if hitboxPnjA.colliderect(hitboxPerso)==False and cdvA3.colliderect(hitboxPerso)==False:
            etatPnjA=1
        if hitboxPnjA.colliderect(hitboxPerso)==True and cdvA3.colliderect(hitboxPerso)==True:
            etatPnjA=2
        if hitboxPnjA.colliderect(hitboxPerso)==False and cdvA3.colliderect(hitboxPerso)==True:
            if possibleA==1:
                etatPnjA=3
    ...
    if spnjA==4:
        ...
        if hitboxPnjA.colliderect(hitboxPerso)==False and cdvA4.colliderect(hitboxPerso)==False:
            etatPnjA=1
        if hitboxPnjA.colliderect(hitboxPerso)==True and cdvA4.colliderect(hitboxPerso)==True:
            etatPnjA=2
        if hitboxPnjA.colliderect(hitboxPerso)==False and cdvA4.colliderect(hitboxPerso)==True:
            if possibleA==1:
                etatPnjA=3
                posBalleA=(posPnjA[0]+20,posPnjA[1]-20)
                possibleA=0
...
def déplacementPnjB():
    global posPnjB, spnjB, hitboxPnjB, cdvB1, cdvB2, cdvB3, cdvB4, etatPnjB
    if spnjB==1:
        if etatPnjB==1:
            if posPnjB[0]<1305:
    ...
    if spnjB==3:
        ...
        if hitboxPnjB.colliderect(hitboxPerso)==False and cdvB3.colliderect(hitboxPerso)==False:
            etatPnjB=1
        if hitboxPnjB.colliderect(hitboxPerso)==True and cdvB3.colliderect(hitboxPerso)==True:
            etatPnjB=2
        if hitboxPnjB.colliderect(hitboxPerso)==False and cdvB3.colliderect(hitboxPerso)==True:
            etatPnjB=3
    if spnjB==4:
        if etatPnjB==1:
            if posPnjB[1]>20:
        ...
        if hitboxPnjB.colliderect(hitboxPerso)==False and cdvB4.colliderect(hitboxPerso)==False:
            etatPnjB=1
        if hitboxPnjB.colliderect(hitboxPerso)==True and cdvB4.colliderect(hitboxPerso)==True:
            etatPnjB=2
        if hitboxPnjB.colliderect(hitboxPerso)==False and cdvB4.colliderect(hitboxPerso)==True:
            etatPnjB=3


def déplacementPnjC():
    global posPnjC, spnjC, hitboxPnjC, cdvC1, cdvC2, cdvC3, cdvC4, etatPnjC
    if spnjC == 1:
        if etatPnjC==1:
            if posPnjC[0] < 380:
                ...
                spnjC = 2
                cdvC2=pygame.Rect(posPnjC[0]-10,posPnjC[1]+55,76,130)
        if hitboxPnjB.colliderect(hitboxPerso)==True and cdvC1.colliderect(hitboxPerso)==False:
            etatPnjC=0
        if hitboxPnjB.colliderect(hitboxPerso)==False and cdvC1.colliderect(hitboxPerso)==False:
            etatPnjC=1
        if hitboxPnjB.colliderect(hitboxPerso)==True and cdvC1.colliderect(hitboxPerso)==True:
            etatPnjC=2
        if hitboxPnjB.colliderect(hitboxPerso)==False and cdvC1.colliderect(hitboxPerso)==True:
            etatPnjC=3
    if spnjC == 2:
        if etatPnjC==1:
            if posPnjC[1] < 950:
                ...
                spnjC = 3
                cdvC3=pygame.Rect(posPnjC[0],posPnjC[1]-10,-130,76)
        if hitboxPnjB.colliderect(hitboxPerso)==True and cdvC2.colliderect(hitboxPerso)==False:
            etatPnjC=0
        if hitboxPnjB.colliderect(hitboxPerso)==False and cdvC2.colliderect(hitboxPerso)==False:
            etatPnjC=1
        if hitboxPnjB.colliderect(hitboxPerso)==True and cdvC2.colliderect(hitboxPerso)==True:
            etatPnjC=2
        if hitboxPnjB.colliderect(hitboxPerso)==False and cdvC2.colliderect(hitboxPerso)==True:
            etatPnjC=3
    if spnjC == 3:
        if etatPnjC==1:
            if posPnjC[0] > 60:
                ...
                spnjC = 4
                cdvC4=pygame.Rect(posPnjC[0]-15,posPnjC[1]+5,76,-130)
        if hitboxPnjB.colliderect(hitboxPerso)==True and cdvC3.colliderect(hitboxPerso)==False:
            etatPnjC=0
        if hitboxPnjB.colliderect(hitboxPerso)==False and cdvC3.colliderect(hitboxPerso)==False:
            etatPnjC=1
        if hitboxPnjB.colliderect(hitboxPerso)==True and cdvC3.colliderect(hitboxPerso)==True:
            etatPnjC=2
        if hitboxPnjB.colliderect(hitboxPerso)==False and cdvC3.colliderect(hitboxPerso)==True:
            etatPnjC=3
    if spnjC == 4:
        if etatPnjC==1:
            if posPnjC[1] > 410:
                ...
                spnjC = 1
                cdvC1=pygame.Rect(posPnjC[0]+50,posPnjC[1]-5,130,76)
        if hitboxPnjB.colliderect(hitboxPerso)==True and cdvC4.colliderect(hitboxPerso)==False:
            etatPnjC=0
        if hitboxPnjB.colliderect(hitboxPerso)==False and cdvC4.colliderect(hitboxPerso)==False:
            etatPnjC=1
        if hitboxPnjB.colliderect(hitboxPerso)==True and cdvC4.colliderect(hitboxPerso)==True:
            etatPnjC=2
        if hitboxPnjB.colliderect(hitboxPerso)==False and cdvC4.colliderect(hitboxPerso)==True:
            etatPnjC=3

def déplacementPnjD():
    global posPnjD, spnjD, hitboxPnjD, cdvD1, cdvD2, cdvD3,cdvD4, etatPnjD
    if spnjD == 1:
        if posPnjD[0] < 1330:
...
#Gestion des clics
def gestionClic():
    global posPerso, jeu, hitboxPerso, obstacles, déplacement, chgmtDirection, sens,etatPerso, posKunai, possible, kunaiDispo
