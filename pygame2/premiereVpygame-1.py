...
def déplacementPnjB():
    global posPnjB, spnjB, hitboxPnjB, cdvB1, cdvB2, cdvB3, cdvB4, etatPnjB,possibleB
    if spnjB==1:
        if etatPnjB==1:
            if posPnjB[0]<1305:
...
def déplacementPnjC():
    ...
    if spnjC == 3:
        ...
        if hitboxPnjC.colliderect(hitboxPerso)==False and cdvC3.colliderect(hitboxPerso)==False:
            etatPnjC=1
        if hitboxPnjC.colliderect(hitboxPerso)==True and cdvC3.colliderect(hitboxPerso)==True:
            etatPnjC=2
        if hitboxPnjC.colliderect(hitboxPerso)==False and cdvC3.colliderect(hitboxPerso)==True:
            etatPnjC=3
    if spnjC == 4:
        if etatPnjC==1:
            if posPnjC[1] > 410:
        ...
        if hitboxPnjC.colliderect(hitboxPerso)==False and cdvC4.colliderect(hitboxPerso)==False:
            etatPnjC=1
        if hitboxPnjC.colliderect(hitboxPerso)==True and cdvC4.colliderect(hitboxPerso)==True:
            etatPnjC=2
        if hitboxPnjC.colliderect(hitboxPerso)==False and cdvC4.colliderect(hitboxPerso)==True:
            etatPnjC=3
...
while jeu==1:
    ...
    if posBalleB!=(-50,-50):
        ...
        if possibleB==0:
            if sensBalleB==1:
                posBalleA=(posBalleB[0]+10, posBalleB[1])
